                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Дата видання: <br>
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#buyMagazineModal">Придбати</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Ви дісно хочете додати до кошика?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Відмінити</button>
                            <button type="button" magazineID="${magazine.id}" class="btn btn-primary buy-magazine">Придбати</button>
                        </div>
                    </div>
                </div>
            </div>
